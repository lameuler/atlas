...
/**
 * The options for the `astro-pdf` integration.
 * @public
 */
export interface Options {
    ...
    /**
     * Specifies whether to install a browser, or options to pass to Puppeteer {@link https://pptr.dev/browsers-api/browsers.install | `install`}
     *
     * @remarks
    ...
    /**
     * Options to pass to Puppeteer {@link https://pptr.dev/api/puppeteer.puppeteernode.launch | `launch`} for launching the browser.
     */
...
export interface PageOptions {
    ...
    navTimeout?: number
    /**
     * Options to be passed to {@link https://pptr.dev/api/puppeteer.page.createpdfstream | `Page.createPDFStream`} to specify how the PDF is generated.
     *
     * @remarks
...
export function getPageOptions(
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        if (opts) {
            const partial =
                typeof opts === 'object' ? opts : typeof opts === 'string' ? { path: opts } : {}
            const options = {
                ...baseOptions,
                ...partial,
            }
